  ...
  if (t.img) {
    return (
      <div className="fighter-wrap">
        {showAura && (
          <div
            className="fighter-aura aura"
            style={{ background: `radial-gradient(ellipse at 50% 60%, ${t.aura}88 0%, ${t.aura}22 50%, transparent 70%)`, opacity: t.auraOp }}
          />
        )}
        <img
      ...
      <svg className="fighter-svg" viewBox="0 0 132 150" aria-hidden="true">
        ...
        <g className="float">
          <path
            ...
            opacity="0.9"
          />
          <path d="M46 78 C 46 70, 86 70, 86 78 L92 118 C 92 126, 40 126, 40 118 Z" fill="url(#giGrad)" stroke="#7a2f00" strokeWidth="1.2" />
          ...
          <path
            d="M48 50 C 44 32, 50 22, 56 30 L54 14 L62 28 L64 10 L70 28 L72 12 L78 30 C 84 22, 90 34, 84 50 C 80 40, 74 38, 66 40 C 58 38, 52 40, 48 50 Z"
            fill="url(#hairGrad)"
